...
def calculation_num_matches(costs_dict, stats_dict):
    num_matches = 0
    for player in costs_dict:
        if player in stats_dict:

        else:
            print(player + " not found in stats")
        if player_name in costs_dict:
            #print(player_name)
